...
1. Use the following code to create a user defined function in the user defined function Body. **note if not able to edit just save the udf with the name producttax then refresh the window and then navigate to the udf and then edit**
